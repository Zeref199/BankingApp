package com.bank.front.transaction.service;
...
import com.bank.front.transaction.repository.TransactionHistoryRepository;
...
public class TransactService {
    ...
    @Autowired
    public TransactService(AccountRepository accountRepository, TransactionHistoryRepository transactionHistoryRepository) {
    ...
    public String deposit(Customer customer, String depositAmount, String accountID) {
        ...
        transactionHistoryRepository.logTransaction(customer.getId(), acc_id, "deposit", depositAmountValue, "online", "success", "Deposit Transaction Successful", formattedDateTime);
    ...
    public String transfer(Customer customer, String transfer_from, String transfer_to, String transfer_amount) {
        ...
        if(currentBalanceOfAccountTransferringFrom < transferAmount){
            ...
            transactionHistoryRepository.logTransaction(customer.getId(), transferFromId, "Transfer", transferAmount, "online", "failed", "Insufficient Funds", formattedDateTime);
        ...
        transactionHistoryRepository.logTransaction(customer.getId(), transferFromId, "Transfer", transferAmount, "online", "success", "Transfer Transaction Successful",formattedDateTime);
    ...
    public String withdraw(Customer customer, String withdrawalAmount, String accountID) {
        ...
        if(currentBalance < withdrawal_amount){
            // Log Failed Transaction:
            transactionHistoryRepository.logTransaction(customer.getId(), account_id, "Withdrawal", withdrawal_amount, "online", "failed", "Insufficient Funds", formattedDateTime);
        ...
        // Log Successful Transaction:
        transactionHistoryRepository.logTransaction(customer.getId(), account_id, "Withdrawal", withdrawal_amount, "online", "success", "Withdrawal Transaction Successful",formattedDateTime);
